...
#define REG_Motion                               0x02      //Decimal (regular #) value of 2
...
#define REG_Minimum_Pixel                        0x0a      //Decimal (regular #) value of 10
#define REG_Shutter_Lower                        0x0b      //Decimal (regular #) value of 11
#define REG_Shutter_Upper                        0x0c      //Decimal (regular #) value of 12
#define REG_Frame_Period_Lower                   0x0d      //Decimal (regular #) value of 13
#define REG_Frame_Period_Upper                   0x0e      //Decimal (regular #) value of 14
#define REG_Configuration_I                      0x0f      //Decimal (regular #) value of 15
...
void setup() {
  ...
  pinMode(ncs, OUTPUT);                             //Pin 4 is output mode
...
void performStartup(void){
  ...
  //******************************
  //Setting CPI http://datasheet.octopart.com/ADNS-9800-Avago-datasheet-10666463.pdf
  //****************************
  adns_write_reg(REG_Configuration_I, 0x01); // 200 cpi
  delay(10);
  //******************************
  
  //enable laser(bit 0 = 0b), in normal mode (bits 3,f2,1 = 000b)
...
void UpdatePointer(void){
  if(initComplete==9){
    ...
    //Serial.println(String(float(*x)/200*2.54)+" "+String(float(*y)/200*2.54));
    ax=ax+(float(*x)/200*2.54);
    ay=ay+(float(*y)/200*2.54);
    if(abs(ax) >= sum | abs(ay) >=sum) //check for ax=0?
    {
